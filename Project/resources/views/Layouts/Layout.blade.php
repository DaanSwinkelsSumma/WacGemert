    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Competitie</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Beker</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Teams</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Organisatie</a>
                </li>
                <li class="nav-item">
        ...
        <footer class="footer-distributed">
            <div class="footer-left">
                <a href="/home" >           
                    <img alt="Kuijpers Logo" src="{{ asset('img/WacLogo.png') }}" class="img-fluid" id="wizlogofooter" height="200" width="200">
                </a>
